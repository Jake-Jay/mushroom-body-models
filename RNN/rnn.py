...
class MaskedNeuralRNN(nn.Module):
    def __init__(self, input_mask, output_mask, nonlinearity="tanh"):
        ...
        self.hidden_size = output_mask.shape[0]

        self.W_xh = CustomizedLinear(self.input_mask, bias=True)
        self.W_hh = CustomizedLinear(self.output_mask, bias=True)
...
#         pdb.set_trace()
#         Somehow input is 3 dimensional torch.Size([1, 8, 15])
# resulting in it not being a matrix
